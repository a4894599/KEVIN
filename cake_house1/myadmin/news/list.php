                ...
                <table class="table table-striped table-borderless">
                  ...
                  <?php foreach($all_news as $news){ ?>
                    <tr>
                      ...
                      <td>
                      <a class="btn btn-secondary" href="edit.php?categoryID=<?php echo $news['news_categoryID'];?>&newsID=<?php echo $news['news_id']; ?>"><i class="fa fa-pencil-square-o fa-fw"></i>&nbsp;編輯</a>
                          <a onclick="if(!confirm('是否確定刪除此筆資料?刪除後無法回復')){return false;};" class="btn btn-secondary ml-2" 
                          href="delete.php?categoryID=<?php echo $news['news_categoryID'];?>&gnewsID=<?php echo $news['news_id']; ?>">
