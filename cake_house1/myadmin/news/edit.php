...
if(isset($_POST['EditForm']) && $_POST['EditForm'] == "EDIT"){
  ...
  $sql= "UPDATE news SET published_date =:published_date, title = :title, picture = :picture, description = :description, updated_at=:updated_at where news_id = :news_id";
  $sth = $db ->prepare($sql);
  ...
  header('Location: list.php?categoryID='.$_POST['categoryID']);
    ...
    $query = $db->query("SELECT * FROM news WHERE news_id = ".$_GET['newsID']);
          ...
          <div class="card">
            ...
            <div class="card-body">
              <ul class="breadcrumb mb-2">
                ...
                <li class="breadcrumb-item active">編輯資料</li>
              </ul>
              <div class="row">
