...
if(isset($_POST['AddForm']) && $_POST['AddForm'] == "INSERT"){
  ...
  $sql= "INSERT INTO news  (news_categoryID,published_date, picture, title, description, created_at) VALUES ( :news_categoryID, :published_date, :picture, :title, :description, :created_at)";
  $sth = $db ->prepare($sql);
