                    ...
                    <div class="panel panel-default sidebar-menu">
                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                ...
                                <li>
                                    <a href="product_list.php">產品分類 <span class="badge pull-right">10</span></a>
                        ...
                        <div class="col-sm-6">
                            <form action="cart/add_cart.php" method="post">
                                <div class="box">
                                    ...
                                    <input type="hidden" name="pic" value="wood-food-bread.jpg">
...
<div class="modal fade" id="info-modal" tabindex="-1" role="dialog" aria-labelledby="info" aria-hidden="false">
