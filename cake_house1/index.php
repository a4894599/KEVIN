...
<?php
    $query = $db->query("SELECT * FROM product_category ORDER BY product_categoryID DESC");
   ...
   <div id="top">
       <div class="container">
           <div class="col-md-6 offer" data-animate="fadeInDown">
               <a href="#" class="btn btn-success btn-sm" data-animate-hover="shake">前往加入會員</a>  <a href="#"></a>
           </div>
           <div class="col-md-6" data-animate="fadeInDown">
               <ul class="menu">
               <?php if(isset($_SESSION['user']) && $_SESSION['user'] !=null) { ?>
                    <li><a href="#" data-toggle="modal" data-target="#login-modal">您好!</a>
                   </li>
                    <li>
                        <a href="web/functions/logout.php"><i class="fa fa-sign-out"></i> 登出</a>
                    </li>
               <?php }else{ ?>
       ...
       <div class="container">
           ...
           <div class="navbar-buttons">
               ...
               <div class="navbar-collapse collapse right" id="basket-overview">
                   <a href="web/basket.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm">(<?php if(isset($_SESSION['Cart']) && $_SESSION['Cart'] != null) echo count($_SESSION['Cart']); else echo "0"; ?>)</span></a>
               </div>
               <!--/.nav-collapse -->
                    ...
                    <div class="product-slider">
                        <div class="item">
                            <div class="product">
                                ...
                                <a href="web/detail.html" class="invisible">
                                    <img src="img/product1.jpg" alt="" class="img-responsive">
                                </a>
                                <div class="text">
                                    <h3><a href="web/detail.html">Fur coat with very but very very long name</a></h3>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="web/detail.html">White Blouse Armani</a></h3>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="web/detail.html">Black Blouse Versace</a></h3>
                                    <p class="price">$143.00</p>
                                </div>
                                <!-- /.text -->
                            </div>
