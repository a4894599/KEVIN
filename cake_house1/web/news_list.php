            ...
            <div class="container">
		     ...
		     _________________________________________________________ -->
                ...
                <div class="col-sm-9" id="blog-listing">
                    ...
                    <div class="post">
                        <h2><a href="news?php"><?php echo $news['title']; ?></a></h2>
                       
                        <hr>
                        <p class="date-comments">
                            <a href="news?php?gnewsID=<?php echo $news['news_id'];?>"><i class="fa fa-calendar-o"></i><?php echo $news['published_date']; ?></a>
                           
                        </p>
                       
                        <p class="intro"><?php echo substr($news['description'],0,300) ?></p>
                        <p class="read-more"><a href="news.php?gnewsID=<?php echo $news['news_id'];?>" class="btn btn-primary">了解更多</a>
                        </p>
                    </div>
                    <?php } ?>
                    <?php
