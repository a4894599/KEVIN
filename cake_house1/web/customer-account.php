...
if(isset($_POST['EditForm']) && $_POST['EditForm'] == "UPDATE"){
    ...
    $sql= "UPDATE member SET name=:name,birthday=:birthday, gender=:gender ,phone=:phone , zipcode=:zipcode, county=:county, district=:district, address=:address, mobile=:mobile,email=:email WHERE memberID= :memberID";
    ...
    $sth ->execute();
     ...
     $query = $db->query("SELECT * FROM member WHERE memberID = ".$_SESSION['user']);
...
<?php require_once('template/navbar.php'); ?>
 ...
 _________________________________________________________ -->
        ...
        $(function(){
            ...
            $('input[name="county"]').eq(1).hide();
            $('input[name="district"]').eq(1).hide();
        });
        </script>
