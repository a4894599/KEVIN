<?php
    $query = $db->query("SELECT * FROM product_category ORDER BY category DESC");
    $all_product_category = $query->fetchAll(PDO::FETCH_ASSOC);
    ?>
   <div id="top">
       <div class="container">
           <div class="col-md-6 offer" data-animate="fadeInDown">
               <a href="#" class="btn btn-success btn-sm" data-animate-hover="shake">前往加入會員</a>  
           </div>
          <div class="col-md-6" data-animate="fadeInDown">
               <ul class="menu">
               <?php if(isset($_SESSION['user']) && $_SESSION['user'] !=null) { ?>
                    <li><a href="customer-account.php" >您好!</a>
                   </li>
                    <li>
       ...
       <div class="container">
           <div class="navbar-header">
               ...
               <a class="navbar-brand home" href="../index.php" data-animate-hover="bounce">
                   ...
                   <img src="../images/logo.png" alt="Cake House logo" class="visible-xs"><span class="sr-only">Cake House - go to homepage</span>
               </a>
