...
$sth = $db->prepare($sql);
$sth ->bindParam(":memberID", $_SESSION['user']['memberID'],PDO::PARAM_INT); 
...
$sth ->bindParam(":shipping", $_SESSION['Receiver']['shipping'], PDO::PARAM_STR); 
$sth ->bindParam(":pay_method", $_SESSION['Receiver']['pay_method'], PDO::PARAM_STR); 
$sth ->bindParam(":receive_method", $_SESSION['Receiver']['receive_method'], PDO::PARAM_STR); 
$sth ->execute();
                    ...
                    <div class="row" id="error-page">
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="box">
                                ...
                                <a href="functions/Opay/Credit_CreateOrder.php">去付款</a>
                            </div>
                        </div>
                    </div>
