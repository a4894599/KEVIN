...
$_SESSION['Receiver']['address'] = $_POST['zipcode'].$_POST['county'].$_POST['district'];
                        ...
                        <form method="post" action="checkout3.php">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="box shipping-method">
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <input type="hidden" name="delivery_name" id="delivery_name" value="宅配">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    <button type="submit" class="btn btn-primary"  a href="checkout3.php">繼續<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        if($_SESSION['TotalPrice'] > 2000){ ?>
                                            <th class="shipping" name="shipping">NT 0</th>
                                        <?php }else{ ?>
                                            <th class="shipping" name="shipping"></th>
                                        <?php } ?>
                                    </tr>
                                    <tr class="total">
                                        <td>總金額</td>
                                        <th class="totalprice" name="totalprice">$NT 0</th>
                                    </tr>
